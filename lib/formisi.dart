...
import 'package:posttest6_1915016119_s_saleh_ali_al_idrus/checkbox_controller.dart';
import 'package:posttest6_1915016119_s_saleh_ali_al_idrus/radio_controller.dart';
import 'package:posttest6_1915016119_s_saleh_ali_al_idrus/text_controller.dart';
...
class formisi extends StatelessWidget {
  ...
  final radioGetController myRadioController = Get.put(radioGetController());
                  ...
                  child:Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            for(var item in myRadioController.MetodePembayaran)
                            
                            Row(
                              children: [
                                Radio(
                                  value: item, 
                                  groupValue: myRadioController.MPgroup, 
                                  onChanged: (newValue){
                                    myRadioController.MPgroup.value = newValue.toString();
                                  },
                                ),
                                Text(item,
                      ...
                      Obx(() => Text('Metode Pembayaran: ${myRadioController.MPgroup.value}'),),
